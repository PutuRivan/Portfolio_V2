...
const CardStackDetail = ({ TechStackIcon, Language }: Props) => {
  return (
    <div className="h-32 w-32 p-4 rounded-2xl bg-slate-800/50 hover:bg-slate-700/50 transition-all duration-300 ease-in-out flex flex-col items-center justify-center gap-3 hover:scale-105 cursor-pointer shadow-lg hover:shadow-xl">
      <div className="relative">
        ...
        <Image
          ...
          width={40}
          height={40}
          className="relative h-10 w-10 md:h-16 md:w-16 transform transition-transform duration-300"
        />
      </div>
