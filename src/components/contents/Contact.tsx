...
const Contact = () => {
  return (
    ...
    >
      ...
      <div className="card bg-slate-800/50 hover:bg-slate-700/50 transition-all duration-300 ease-in-out w-96 z-10">
        <figure className="px-10 pt-10">
          <Image
            ...
            width={500}
            height={500}
            className="hover:shadow-6xl rounded-full transition-all duration-300 ease-in-out shadow-sky-500"
          />
        </figure>
        <div className="card-body items-center text-center gap-5">
          <h2 className="card-title text-white">Let&apos;s Connect</h2>
          <p className="text-white">Check My Social Media</p>
        </div>
